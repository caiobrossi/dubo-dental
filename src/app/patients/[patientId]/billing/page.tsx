...
function BillingPage() {
  ...
  const [activeSegment, setActiveSegment] = useState("billing");
  ...
  // Load billing entries for this patient (using mock data for now)
    ...
    const mockBillingEntries: BillingEntry[] = [
      {
        id: "1",
        date: "03/02/2025",
        treatment_code: "03394",
        treatment_name: "Dental Treatment",
      ...
      },
      {
        id: "2",
        date: "03/02/2025",
        treatment_code: "03392",
        treatment_name: "Injectables treatment",
        invoice_url: "Invoice.pdf",
        professional_name: "Susan Miller",
        payment_type: "Mbway",
        status: "Pending",
        total_price: 235.00
      },
  ...
  // Load billing entries when patient is loaded
  useEffect(() => {
              ...
              <div className="w-full max-w-[2000px] mx-auto px-4 space-y-8">
                ...
                <div className="flex w-full flex-col items-start gap-8 px-2 py-2">
                  <div className="flex w-full items-start gap-2">
                    <div className="flex grow shrink-0 basis-0 flex-col items-start gap-6 rounded-md bg-neutral-50 px-4 py-4">
                      <div className="flex w-full items-center justify-between">
                        <div className="flex items-center gap-2">
                          <IconWithBackground
                            variant="success"
                            size="medium"
                            icon={<FeatherArrowDownLeft />}
                            square={false}
                          />
                    ...
                    <div className="flex flex-wrap items-center justify-center">
                      <SubframeCore.DropdownMenu.Root>
                        ...
                        <SubframeCore.DropdownMenu.Portal>
                          ...
                          >
                            <DropdownMenu>
                              <DropdownMenu.DropdownItem>Favorite</DropdownMenu.DropdownItem>
                  ...
                  <div className="flex w-full flex-col items-start justify-end gap-4">
                    <Table
                      ...
                      header={
                        <Table.HeaderRow className="w-full grow shrink-0 basis-0">
                          <Table.HeaderCell className="h-10 w-10 flex-none" variant="checkbox">
                            <Checkbox
                              label=""
                              checked={false}
                    ...
                    >
                      {billingEntries.map((entry: BillingEntry) => (
                        <Table.Row key={entry.id}>
                          <Table.Cell className="h-16 w-10 flex-none">
                            <Checkbox
                              label=""
                              checked={false}
                              onCheckedChange={(checked: boolean) => {}}
                          ...
                          <Table.Cell className="h-16 grow shrink-0 basis-0">
                            <span className="whitespace-pre-wrap text-body-medium font-body-medium text-neutral-500">
                              {entry.date}
                            </span>
                          </Table.Cell>
                          <Table.Cell className="h-16 grow shrink-0 basis-0">
                            <LinkButton
                              ...
                              onClick={(event: React.MouseEvent<HTMLButtonElement>) => {}}
                            >
                              {entry.treatment_code} - {entry.treatment_name}
                            </LinkButton>
                          </Table.Cell>
                          <Table.Cell className="h-16 grow shrink-0 basis-0">
                            <LinkButton
                          ...
                          <Table.Cell className="h-16 grow shrink-0 basis-0">
                            <Chips 
                              variant={entry.status === 'Paid' || entry.status === 'Received' ? 'success' : 'warning'} 
                              icon={<FeatherMinus />} 
                              size="large"
                            >
                              {entry.status}
