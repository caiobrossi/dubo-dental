...
function ChartingPage() {
  ...
  const [activeSegment, setActiveSegment] = useState("charting");
                      ...
                      <>
                        ...
                        <div className="flex flex-col items-start justify-end gap-2">
                          ...
                          <span className="text-body-small font-body-small text-subtext-color">
                            Map Teeth, restorations and cavities
                          </span>
                        </div>
                      </>
                    }
                    ...
                    content={
                      <>
                        ...
                        <div className="flex flex-col items-start justify-end gap-2">
                          ...
                          <span className="text-body-small font-body-small text-subtext-color">
                            Record pocket depth and gum health
                          </span>
                        </div>
                      </>
                    }
                    ...
                    content={
                      <>
                        ...
                        <div className="flex flex-col items-start justify-end gap-2">
                          ...
                          <span className="text-body-small font-body-small text-subtext-color">
                            Map alignment and tooth movements
                          </span>
                        </div>
                      </>
                    }
                    ...
                    content={
                      <>
                        ...
                        <div className="flex flex-col items-start justify-end gap-2">
                          ...
                          <span className="text-body-small font-body-small text-subtext-color">
                            Plan cosmetic improvements to the smile
                          </span>
                        </div>
                      </>
                    }
                    ...
                    content={
                      <>
                        ...
                        <div className="flex flex-col items-start justify-end gap-2">
                          ...
                          <span className="text-body-small font-body-small text-subtext-color">
                            Crowns, bridges, dentures and implant supported work
                          </span>
                        </div>
                      </>
                    }
                    ...
                    content={
                      <>
                        ...
                        <div className="flex flex-col items-start justify-end gap-2">
                          ...
                          <span className="text-body-small font-body-small text-subtext-color">
                            Facial injection sites and product usage for aesthetics
                          </span>
                        </div>
                      </>
                    }
                  ...
                  <div className="border border-neutral-200 rounded-lg bg-white overflow-hidden flex-1 flex flex-col">
                    ...
                    <div className="bg-neutral-50 border-b border-neutral-200 sticky top-0 z-[5]">
                      <div className="flex">
                        ...
                        <div className="flex-1 px-4 py-3 text-left text-sm font-medium text-neutral-900 first:pl-6 last:pr-6" style={{ minWidth: 180 }}>
                          Treatment linked
                        </div>
                    ...
                    <div className="overflow-auto flex-1">
                      <div className="w-full">
                        ...
                        <div className="flex items-center border-b border-neutral-200 hover:bg-neutral-50 transition-colors" style={{ minHeight: 80 }}>
                          ...
                          <div className="flex-1 px-4 py-3 text-sm text-neutral-900 first:pl-6 last:pr-6 overflow-hidden" style={{ minWidth: 180 }}>
                            <span className="whitespace-nowrap text-body-medium font-body-medium text-neutral-500">
                              3 treatments linked
                            </span>
                          </div>
