...
export default function PrivatePlanDetailedPage() {
  ...
  return (
    <div className="h-screen w-screen bg-default-background flex flex-col">
      ...
      {/* Filter Section */}
      <div className="flex w-full flex-wrap items-center justify-between px-6 py-4 bg-white border-b border-neutral-200 flex-shrink-0">
        <div className="flex items-center gap-4">
          <SubframeCore.DropdownMenu.Root>
          ...
          <div className="relative">
            ...
            >
              <TextField.Input
                ...
                placeholder="Search procedures by name, category, price, or time..."
                value={searchFilter}
