...
/*
 * Documentation:
 * Vertical Stepper — https://app.subframe.com/e50163b8c1bc/library?component=Vertical+Stepper_bdc0291d-b5be-40c5-ae2f-527a868488b2
 */
    ...
    >
      ...
      >
        ...
        >
          {stepNumber ? (
            <span
              className={SubframeUtils.twClassNames(
                "text-body-large font-body-large text-subtext-color text-center",
                {
                  "text-body-large font-body-large text-brand-700":
                    variant === "active",
      ...
      >
        {label ? (
          <span
            className={SubframeUtils.twClassNames(
              "line-clamp-2 w-full text-body-medium font-body-medium text-subtext-color",
              {
                "text-body-large font-body-large text-default-font":
                  variant === "active",
