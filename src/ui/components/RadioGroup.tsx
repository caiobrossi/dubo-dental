...
/*
 * Documentation:
 * Radio Group — https://app.subframe.com/e50163b8c1bc/library?component=Radio+Group_c4b6300e-20b4-4f3e-8b9f-379a046674ca
 */
  ...
  return (
    <SubframeCore.RadioGroup.Item asChild={true} {...otherProps}>
      ...
      >
        ...
        {label ? (
          <span className="grow shrink-0 basis-0 text-body-medium font-body-medium text-default-font group-disabled/0f804ad9:text-subtext-color">
            {label}
          </span>
        ) : null}
      </button>
      ...
      <SubframeCore.RadioGroup.Root asChild={true} {...otherProps}>
        <div
          className={SubframeUtils.twClassNames(
            ...
            {
              "items-start justify-center": horizontal,
              "flex-col flex-nowrap gap-2": error,
            },
            className
          )}
          ref={ref}
