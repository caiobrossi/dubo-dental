...
/*
 * Documentation:
 * Context Menu — https://app.subframe.com/e50163b8c1bc/library?component=Context+Menu_f8a49f07-fa5b-46c8-9399-cbbf0930cc62
 */
    ...
    return (
      <SubframeCore.ContextMenu.Item asChild={true} {...otherProps}>
        ...
        >
          ...
          {children ? (
            <span className="line-clamp-1 grow shrink-0 basis-0 text-body-medium font-body-medium text-default-font group-hover/9358ee78:text-default-font">
              {children}
            </span>
          ) : null}
          {rightSlot ? (
