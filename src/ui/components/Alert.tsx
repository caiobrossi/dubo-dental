...
/*
 * Documentation:
 * Alert — https://app.subframe.com/e50163b8c1bc/library?component=Alert_3a65613d-d546-467c-80f4-aaba6a7edcd5
 */
      ...
      >
        <div
          className={SubframeUtils.twClassNames(
            ...
            { "items-start justify-center": variant === "brand" }
          )}
        >
          {icon ? (
          ...
          <div
            className={SubframeUtils.twClassNames(
              ...
              { "flex-col flex-nowrap gap-1": variant === "brand" }
            )}
          >
            {title ? (
              <span
                className={SubframeUtils.twClassNames(
                  "w-full whitespace-pre-wrap text-body-large font-body-large text-default-font",
                  {
                    "text-warning-900": variant === "warning",
                    "text-success-900": variant === "success",
                    "text-error-900": variant === "error",
                    "text-body-medium font-body-medium text-brand-900":
                      variant === "brand",
                  }
                )}
              >
              ...
              <span
                className={SubframeUtils.twClassNames(
                  "w-full whitespace-pre-wrap text-caption font-caption text-subtext-color",
                  {
                    ...
                    "text-success-800": variant === "success",
                    "text-error-800": variant === "error",
                    "text-body-small font-body-small text-brand-800":
                      variant === "brand",
                  }
                )}
              >
