 ...
 * Tree View — https://app.subframe.com/e50163b8c1bc/library?component=Tree+View_4ed46422-ecc3-41e8-8787-e55ee10cdc75
 */
    ...
    <Accordion
      ...
      trigger={
        <div className="flex w-full items-center gap-2 rounded-md px-3 py-2 group-hover/c841484c:bg-neutral-50">
          ...
          {label ? (
            <span className="line-clamp-1 grow shrink-0 basis-0 text-body-medium font-body-medium text-default-font">
              {label}
            </span>
          ) : null}
          <Accordion.Chevron />
