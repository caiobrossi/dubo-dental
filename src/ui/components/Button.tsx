...
/*
 * Documentation:
 * Button — https://app.subframe.com/e50163b8c1bc/library?component=Button_3b777358-b86b-40af-9327-891efc6826fe
 */
    ...
    return (
      <button
        className={SubframeUtils.twClassNames(
          "group/3b777358 flex h-8 cursor-pointer items-center justify-center gap-4 rounded-full border-none bg-brand-600 px-3 hover:bg-brand-500 active:bg-brand-600 disabled:cursor-default disabled:bg-neutral-200 hover:disabled:cursor-default hover:disabled:bg-neutral-200 active:disabled:cursor-default active:disabled:bg-neutral-200",
          {
            "h-6 w-auto flex-row flex-nowrap gap-1 px-2 py-0": size === "small",
            "h-10 w-auto px-4 py-0": size === "large",
            "border border-solid border-neutral-border bg-default-background hover:border hover:border-solid hover:border-neutral-border hover:bg-success-200 active:bg-success-100":
              variant === "success",
      ...
      >
        {icon ? (
          <SubframeCore.IconWrapper
            className={SubframeUtils.twClassNames(
              "text-body-medium font-body-medium text-white group-disabled/3b777358:text-neutral-400",
              {
                hidden: loading,
                "text-body-medium font-body-medium": size === "small",
                "text-heading-3 font-heading-3": size === "large",
                "group-hover/3b777358:text-success-700 group-active/3b777358:text-success-700":
                  variant === "success",
        ...
        {children ? (
          <span
            className={SubframeUtils.twClassNames(
              "whitespace-nowrap text-body-medium font-body-medium text-white group-disabled/3b777358:text-neutral-400",
              {
                hidden: loading,
                "text-body-small font-body-small": size === "small",
                "text-body-medium font-body-medium": size === "large",
                "text-default-font group-hover/3b777358:text-success-700 group-active/3b777358:text-success-700":
                  variant === "success",
                "text-white": variant === "inverse",
                "text-error-700":
                  variant === "destructive-tertiary" ||
