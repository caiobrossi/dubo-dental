...
/*
 * Documentation:
 * Toast — https://app.subframe.com/e50163b8c1bc/library?component=Toast_2c7966c2-a95d-468a-83fe-bf196b95be7a
 */
      ...
      >
        ...
        <div className="flex grow shrink-0 basis-0 flex-col items-start">
          {title ? (
            <span
              className={SubframeUtils.twClassNames(
                "w-full text-body-large font-body-large text-default-font",
                {
                  "text-success-700": variant === "success",
                  "text-error-700": variant === "error",
