...
/*
 * Documentation:
 * Copy to clipboard button — https://app.subframe.com/e50163b8c1bc/library?component=Copy+to+clipboard+button_e8c76626-6462-4f2f-b595-38d530d427e8
 * Tooltip — https://app.subframe.com/e50163b8c1bc/library?component=Tooltip_ccebd1e9-f6ac-4737-8376-0dfacd90c9f3
 */
      ...
      <SubframeCore.Tooltip.Root>
        <SubframeCore.Tooltip.Trigger asChild={true}>
          ...
          >
            ...
            >
              {icon ? (
                <SubframeCore.IconWrapper className="text-body-medium font-body-medium text-subtext-color group-hover/e8c76626:text-default-font">
                  {icon}
