...
/*
 * Documentation:
 * Filter Badge — https://app.subframe.com/e50163b8c1bc/library?component=Filter+Badge_9f379f68-a795-4bb7-a975-8b10f72f2f30
 */
      ...
      >
        <div className="flex items-center gap-2 px-2">
          {label ? (
            <span
              className={SubframeUtils.twClassNames(
                "text-body-small font-body-small text-default-font",
        ...
        >
          {count ? (
            <span
              className={SubframeUtils.twClassNames(
                "text-body-small font-body-small text-default-font text-center",
                { "text-brand-700": selected }
              )}
            >
              {count}
