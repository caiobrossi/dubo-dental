...
/*
 * Documentation:
 * Loader — https://app.subframe.com/e50163b8c1bc/library?component=Loader_f2e570c8-e463-45c2-aae9-a960146bc5d5
 */
  ...
  return (
    <SubframeCore.Loader
      className={SubframeUtils.twClassNames(
        "group/f2e570c8 text-body-medium font-body-medium text-brand-600",
        {
