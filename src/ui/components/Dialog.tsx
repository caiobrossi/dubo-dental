...
/*
 * Documentation:
 * Dialog — https://app.subframe.com/e50163b8c1bc/library?component=Dialog_ca59db17-43fb-4247-8094-3c55162e902d
 */
    ...
    <SubframeCore.Dialog.Content asChild={true} {...otherProps}>
      <div
        className={SubframeUtils.twClassNames(
          "flex min-w-[320px] flex-col items-start gap-2 rounded-md border border-solid border-neutral-border bg-white shadow-lg max-h-[90vh] overflow-auto",
          className
        )}
        ref={ref}
      >
  ...
  function DialogRoot(
    ...
    return children ? (
      <SubframeCore.Dialog.Root asChild={true} {...otherProps}>
        <div
          className={SubframeUtils.twClassNames(
            "flex h-full w-full flex-col items-center justify-center gap-2 bg-black/20 backdrop-blur-sm z-50",
            className
          )}
          ref={ref}
        >
