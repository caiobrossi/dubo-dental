...
/*
 * Documentation:
 * Toggle Group — https://app.subframe.com/e50163b8c1bc/library?component=Toggle+Group_2026f10a-e3cc-4c89-80da-a7259acae3b7
 */
      ...
      >
        {icon ? (
          <SubframeCore.IconWrapper
            className={SubframeUtils.twClassNames(
              "text-body-medium font-body-medium text-subtext-color group-hover/56dea6ed:text-default-font group-active/56dea6ed:text-default-font group-aria-[checked=true]/56dea6ed:text-default-font",
              {
        ...
        {children ? (
          <span
            className={SubframeUtils.twClassNames(
              "whitespace-nowrap text-body-small font-body-small text-subtext-color group-hover/56dea6ed:text-default-font group-active/56dea6ed:text-default-font group-aria-[checked=true]/56dea6ed:text-default-font",
              {
                "text-neutral-400 group-hover/56dea6ed:text-neutral-400 group-active/56dea6ed:text-neutral-400":
                  disabled,
              }
  ...
  function ToggleGroupRoot(
    ...
    return children ? (
      <SubframeCore.ToggleGroup.Root asChild={true} {...otherProps}>
        <div
          className={SubframeUtils.twClassNames(
            "flex h-10 items-center gap-1 overflow-hidden rounded-md bg-default-background px-0.5 py-0.5",
            className
          )}
          ref={ref}
        >
