...
/*
 * Documentation:
 * Stepper — https://app.subframe.com/e50163b8c1bc/library?component=Stepper_3c5d47dc-1b1a-45d9-b244-18422d7bfb56
 */
  ...
  return (
    ...
    >
      ...
      {label ? (
        <span
          className={SubframeUtils.twClassNames(
            "text-body-medium font-body-medium text-subtext-color group-hover/c1145464:text-default-font",
            {
