...
/*
 * Documentation:
 * Text Area — https://app.subframe.com/e50163b8c1bc/library?component=Text+Area_4ec05ee8-8f1c-46b2-b863-5419aa7f5cce
 */
  ...
  return (
    <textarea
      className={SubframeUtils.twClassNames(
        "min-h-[96px] w-full border-none bg-transparent px-2 py-1.5 text-body-medium font-body-medium text-default-font outline-none placeholder:text-neutral-400",
        className
      )}
    ...
    return (
      ...
      >
        ...
        {children ? (
          <div
            className={SubframeUtils.twClassNames(
              "flex w-full grow shrink-0 basis-0 flex-col items-start rounded-md border border-solid border-neutral-border bg-default-background pl-1 group-focus-within/4ec05ee8:border-2 group-focus-within/4ec05ee8:border-solid group-focus-within/4ec05ee8:border-brand-primary",
              {
